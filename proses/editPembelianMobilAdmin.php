...
if (isset($_POST['store'])) {
    ...
    if ($edit) {
        echo '<script>alert("[ADMIN] Success Edit Pembelian!"); window.location ="../dashboard/listPembelianAdmin.php"</script>';
    } else {
        echo '<script>alert("Gagal Edit Pembelian!"); window.location ="../dashboard/formEditPembelianMobilAdmin.php"</script>';
    }
} else {
