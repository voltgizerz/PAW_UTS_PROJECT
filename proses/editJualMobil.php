...
if(isset($_POST['storeMobil']) && ! empty($_POST['id'])){
    ...
    if($edit){
        echo '<script>alert("Success Edit Data Penjualan Mobil!"); window.location ="../dashboard/listPenjualanMobil.php"</script>';
    }else{
        echo '<script>alert("Gagal Edit Data Penjualan Mobil!"); window.location ="../dashboard/formJualMobil.php"</script>';
    }
    }else{
