...
<div id="dashboardData">
    <div id="cetak">
        <a target="_blank" href="../laporan/pdfSparepartAdmin.php" class="button4" style="background-color:#f14e4e">PRINT DATA TO PDF</a>
        <a style="color:red;"> <b> WARNING!!! Hanya Admin yang boleh mengakses AREA ini!</b></a> dibawah ini adalah data Penjualan Semua Sparepart Richz Auto!.
    </div>
    <table class="userListTable">
        ...
        <?php
        $query = mysqli_query($con, "SELECT * FROM sparepart") or die(mysqli_error($con));
        ...
        <td><a href="../dashboard/formEditSparepartAdmin.php?id=' . $data['id'] . '"><div id="btnRed"><center>Edit</div> </a>
