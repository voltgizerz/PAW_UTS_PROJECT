            ...
            <div class="columns">
                <div class="column" style="padding:100px">
                    <table border=2>
                        <tr>
                            <td>
                                <img src="./image/lambo.aven.png" width="100%" height="200px">
                            </td>
                            <td>
                                <h1 class="nama_mobil">Aventador</h1>
                                <br />
                                <p>- Good Quality</p>
                                <p>- Mulus</p>
                                <p>- No Minus</p>
                        ...
                        <tr>
                            <td width=400 height=100>
                                <img src="./image/lambo.sesto.png" width="100%" height="200px">
                            </td>
                            <td width=500>
                                <h1 class="nama_mobil">Sesto Elemento</h1>
                                <br />
                                <p>- Good Quality</p>
                                <p>- Mulus</p>
                                <p>- No Minus</p>
