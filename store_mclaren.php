...
<body>
    ...
    <p align="center">
        <h1 class="judul" style="text-align:center;">McLaren</h1>
        <p>
            ...
            <div class="columns">
                <div class="column" style="padding:100px">
                    <table border=2>
                        <tr>
                            <td>
                                <img src="./image/mclaren.570s.png" width="100%" height="200px">
                            </td>
                            <td>
                                <h1 class="nama_mobil">570s Spider</h1>
                                <br />
                                <p>- Good Quality</p>
                                <p>- Mulus</p>
                                <p>- No Minus</p>
                        ...
                        <tr>
                            <td width=400 height=100>
                                <img src="./image/mclaren.sena.png" width="100%" height="200px">
                            </td>
                            <td width=500>
                                <h1 class="nama_mobil">Sena</h1>
                                <br />
                                <p>- Good Quality</p>
                                <p>- Mulus</p>
                                <p>- No Minus</p>
