        ...
        <div class="column is-one-quarter" style="margin:auto;">
            <div class="card">
                <header class="card-header">
                    ...
                    <a href="login_page.php"> <img src="./image/user.png" height="100" width="100"></a>
                     &nbspLogin Page Member
                    </p>
                </header>
            ...
            <small>Not Have Account ? <a href="./register_page.php">Sign Up Now</a></small>
        </div>
    </div>
</body>
